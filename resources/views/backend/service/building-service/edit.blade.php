    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h3 class="fw-bold mb-3">Edit Building Service</h3>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Building Service</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('building-services.update', $buildingService->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!-- Service ID -->
                                        ...
                                        <div class="form-group form-group-default">
                                            ...
                                            <select id="service_id" name="service_id"
                                                ...
                                                @foreach ($services as $service)
                                                    <option value="{{ $service->id }}" {{ $service->id == $buildingService->service_id ? 'selected' : '' }}>
                                                        {{ $service->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group form-group-default">
                                            ...
                                            <select id="type_id" name="type_id"
                                                ...
                                                @foreach ($typeServices as $type)
                                                    <option value="{{ $type->id }}" {{ $type->id == $buildingService->type_id ? 'selected' : '' }}>
                                                        {{ $type->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="surface_area" type="text"
                                                ...
                                                placeholder="Enter surface area in square meters" value="{{ old('surface_area', $buildingService->surface_area) }}" required>
                                            @error('surface_area')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="building_area" type="text"
                                                ...
                                                placeholder="Enter building area in square meters" value="{{ old('building_area', $buildingService->building_area) }}" required>
                                            @error('building_area')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="bedrooms" type="text"
                                                ...
                                                placeholder="Enter number of bedrooms" value="{{ old('bedrooms', $buildingService->bedrooms) }}" required>
                                            @error('bedrooms')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="bathrooms" type="text"
                                                ...
                                                placeholder="Enter number of bathrooms" value="{{ old('bathrooms', $buildingService->bathrooms) }}" required>
                                            @error('bathrooms')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="car_port" type="text"
                                                ...
                                                placeholder="Enter number of car ports" value="{{ old('car_port', $buildingService->car_port) }}" required>
                                            @error('car_port')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-group-default">
                                            ...
                                            @error('room_path')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            @if($buildingService->room_path)
                                                <div class="mt-2">
                                                    <img src="{{ asset($buildingService->room_path) }}" alt="Room Image" width="100">
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="submit" class="btn btn-primary">Update Building Service</button>
